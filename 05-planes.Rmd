...
and London to Los Angeles (9000km), so I think we've slightly
...
cost per person is more if the plane's not full. Scaling down by 10 000
km/14 200 km to get an estimate for Cape Town, then up again by 100/80 to
...
for efficiency improvement sin aviation. The aviation industry is mature.
