...
actual value^[ORNL [2hcgdh] provide the
...
us within 30% of the correct answer. Welcome to guerrilla physics.], for petrol, of 10 kWh per litre.
...
this estimate in the left-hand stack in figure \@ref(fig:stack-1). The red box’s height
...
```{r stack-1, fig.cap="Chapter 3’s conclusion: atypical car-driver uses about 40 kWh per day."}
...
–*... the actual value of 10 kWh per litre.* 
![](images/figure23.png)
