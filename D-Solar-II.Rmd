...
40%-efficient power station, the resulting power per unit area is 0.2 W/m^2^. If
one eighth of Britain (500 m^2^ per person) were covered in these plantations,
...
with the Bavarian solar photo-voltaic farm, for example (5 W/m^2^).
