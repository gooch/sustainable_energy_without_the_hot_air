...
We now need an estimate of the area of sea that could plausibly be covered with wind turbines. It is conventional to distinguish between
*shallow* offshore wind and *deep* offshore wind, as illustrated in
figure 10.2. Conventional wisdom seems to be that *shallow* offshore
...
2008, there's just one deep offshore wind-farm in UK waters, an
experimental prototype sending all its electricity to a nearby oil-rig
called Beatrice.
...
The average power available from shallow offshore wind farms occupying
...
of turbines required. 16 kWh/d per person would be delivered by 44 000
"3 MW" turbines, which works out to 15 per kilometre of coastline, if
...
"deep" offshore wind farms could deliver another 240 GW, or 96 kWh/d
...
turbines, deep offshore wind could deliver a power of 32 kWh/d per
...
incidentally, than micro-turbines. A roof-mounted micro-turbine
currently costs about £1500 and, even at a very optimistic wind speed of
...
months. I share the concern of Bird Life International for the welfare of
rare birds. But I think, as always, it's important to do the numbers.
It's been estimated that 30 000 birds per year are killed by wind
...
peak output of 90 MW, and the predicted average output was 32 MW (assuming a load factor of 36%). The mean wind speed at the hub height is
...
works out to a power density of 2.6 W/m^2^. The North Hoyle wind farm
...
wind association windpower.org.

–*...deep offshore wind is at present not economically feasible.*
Source: British Wind Energy Association briefing document, September
...
126 m. All the electricity generated will be used by the oil
...
10 miles from shore, for reasons of public acceptability; they further
...
November 2002, electricity from offshore wind farms costs about £50
...
pulled out of their commitment to build the London Array. It's because
...
document, estimates for other renewables (medium levelized costs in
...
onshore wind farms, said that he supported the Government's [offshore
...
kWh/d on average. But some micro-turbines deliver only 0.05 kWh per day
...
roof-mounted turbines in towns are usually worse than useless: "in
