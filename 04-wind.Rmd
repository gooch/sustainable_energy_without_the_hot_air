...
Britain. For example, figure 4.1 shows daily average wind speeds in Cambridge
during 2006. The daily average speed reached 6 m/s on only about 30 days of the
year – see figure 4.6 for a histogram. But some spots do have wind speeds above
6 m/s – for example, the summit of Cairngorm in Scotland (figure 4.2).
...
line), and half-hourly (blue line) during 2006^[Cambridge wind data are from the Digital
...
amount to 50 times the entire wind hardware of Denmark^[Assuming a load factor of 33%, an
...
was 3 kWh/d per person.]; 7 times all the wind
...
with a combined *peak* capacity of 322 MW in an area of $55\space km^2$. That's $6 W/m^2$, *peak*. The average power produced is smaller because the turbines
...
load factor of 33% then the average power production per unit land area is $2 W/m^2$
